              ...
              <div className="grid grid-cols-12 items-center gap-8 lg:gap-10">
                ...
                <div className="col-span-12 space-y-6 lg:col-span-6">
                  ...
                  <p className="font-geist max-w-xl text-sm leading-relaxed text-gray-600 lg:text-base">
                    Explore an exclusive catalogue of fine single malts, aged rums, reserve wines,
                    and craft brews. Seamlessly browse by category, check available houses, and
                    manage your member selections.
                  </p>
              ...
              <div className="grid grid-cols-12 items-center gap-8">
                <div className="col-span-12 space-y-4 lg:col-span-6">
                  ...
                  <p className="font-geist max-w-md text-xs leading-relaxed text-gray-300 lg:text-sm">
                    Experience our curated selection of spirits aged for over two decades in rare
                    oak casks. A testament to patience, craft, and the passage of time.
                  </p>
